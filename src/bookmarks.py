...
@jwt_required()
@swag_from("./docs/bookmarks/edit_bookmark_put.yaml")
def put_bookmark(id):
    current_user_id = get_jwt_identity()
...
@jwt_required()
@swag_from("./docs/bookmarks/edit_bookmark_patch.yaml")
def edit_bookmark(id):
    ...
    if "url" in data:
        ...
        bookmark_to_edit.url = data["url"]

    if "body" in data:    
        bookmark_to_edit.body = data["body"]
